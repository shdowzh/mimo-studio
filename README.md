...
| 🪟 **Windows** (x64) 免安装版 | [⬇ 下载 tar.xz](https://gitee.com/shdowzh/mimo-studio/releases/download/v1.4.0/MiMo-Studio-1.4.0-win-x64-Portable.tar.xz) | ~80 MB | 解压即用：`tar xf` 后运行 `MiMo Studio.exe` |
