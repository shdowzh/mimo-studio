...
<p align="center">
  ...
  <a href="https://gitee.com/shdowzh/mimo-studio/releases"><img src="https://img.shields.io/badge/release-v1.1.0-green.svg" /></a>
...
| 平台 | 文件 | 大小 | 说明 |
|------|------|------|------|
| 🪟 **Windows** (x64) 安装版 | `MiMo-Studio-Setup-1.1.0-win-x64.exe` | ~88 MB | NSIS 安装包，双击安装 |
| 🪟 **Windows** (x64) 免安装版 | `MiMo-Studio-1.1.0-win-x64-Portable.tar.xz` | ~87 MB | 解压即用：`tar xf` 后运行 `MiMo Studio.exe` |
| 🐧 **Linux** (x64) | `MiMo-Studio-1.1.0-linux-x64.tar.xz` | ~81 MB | 解压即用，运行 `./mimo-studio` |
| 🍎 **macOS** (Apple Silicon) | `MiMo-Studio-1.1.0-mac-arm64.dmg` | ~147 MB | 双击打开，拖入 Applications |
| 🍎 **macOS** (Intel) | `MiMo-Studio-1.1.0-mac-x64.dmg` | ~151 MB | 双击打开，拖入 Applications |
