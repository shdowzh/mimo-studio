...
<p align="center">
  ...
  <a href="https://gitee.com/shdowzh/mimo-studio/releases"><img src="https://img.shields.io/badge/release-v1.2.0-green.svg" /></a>
...
| 平台 | 下载 | 大小 | 说明 |
|------|------|------|------|
| 🪟 **Windows** (x64) 安装版 | [⬇ 下载 exe](https://gitee.com/shdowzh/mimo-studio/releases/download/v1.2.0/MiMo-Studio-Setup-1.2.0-win-x64.exe) | ~86 MB | NSIS 安装包，支持自定义安装目录 |
| 🪟 **Windows** (x64) 免安装版 | [⬇ 下载 tar.xz](https://gitee.com/shdowzh/mimo-studio/releases/download/v1.2.0/MiMo-Studio-1.2.0-win-x64-Portable.tar.xz) | ~80 MB | 解压即用：`tar xf` 后运行 `MiMo Studio.exe` |
| 🐧 **Linux** (x64) tar.xz | [⬇ 下载 tar.xz](https://gitee.com/shdowzh/mimo-studio/releases/download/v1.2.0/MiMo-Studio-1.2.0-linux-x64.tar.xz) | ~77 MB | 解压即用：`tar xf` 后运行 `./mimo-studio` |
| 🍎 **macOS** (Apple Silicon M1-M4) | [⬇ 下载 tar.xz](https://gitee.com/shdowzh/mimo-studio/releases/download/v1.2.0/MiMo-Studio-1.2.0-mac-arm64.tar.xz) | ~70 MB | 解压即用：`tar xf` 后运行 `MiMo Studio.app` |
| 🍎 **macOS** (Intel) | [⬇ 下载 tar.xz](https://gitee.com/shdowzh/mimo-studio/releases/download/v1.2.0/MiMo-Studio-1.2.0-mac-x64.tar.xz) | ~77 MB | 解压即用：`tar xf` 后运行 `MiMo Studio.app` |
