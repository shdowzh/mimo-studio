...
| 平台 | 包 |
|------|------|
| Windows | `MiMo-Studio-Setup-1.0.0-win-x64.exe` |
| macOS (Intel) | `MiMo-Studio-1.0.0-mac-x64.dmg` |
| macOS (Apple Silicon) | `MiMo-Studio-1.0.0-mac-arm64.dmg` |
| Linux | `MiMo-Studio-1.0.0-linux-x64.AppImage` |
